...
export default function Input(){
    ...
    return(
        <div className='form h-[15%] flex flex-col justify-around relative'>
            ...
            <div className="search-bar rounded-lg border-2 bg-color2 h-[100%] w-[60px] flex items-center justify-center absolute cursor-pointer" onClick={()=>{dispatch(chooseSearch()); reset({title: '', status: 'todo', deadline:'', deadline2:''})}}><i className="fa-regular fa-filter text-2xl"></i></div>
        </div>
    )
}